                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="grid grid-cols-6 gap-6">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="session_title" id="session_title" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="post tile" required="" />
                                    </div>
                                    <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="number" name="session_duration" id="session-duration" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Session Duration" required="" />
                                    </div>
                                ...
                                <div className="p-6 border-t border-gray-200 rounded-b">
                                    <button className="text-white bg-primary   focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Create Session</button>
                                </div>
                            </form>
                        </div>
                    </div>
