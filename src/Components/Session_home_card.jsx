                ...
                <div className="max-w-sm ">
                    <div className="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
                        ...
                        <div className="py-6 px-8 rounded-lg bg-white">
                            ...
                            {
                                isRegistrationOpen ? <Link to={`session_details/${_id}`}><button className="mt-6 py-2 px-4 bg-primary text-white font-bold rounded-lg shadow-md hover:shadow-lg transition duration-300">On Going</button> </Link> : <button className="mt-6 py-2 px-4 bg-primary text-white font-bold rounded-lg shadow-md hover:shadow-lg transition duration-300">Closed</button>
                            }
                        </div>
