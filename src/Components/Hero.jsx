    ...
    return (
        <section className="bg-gray-100  text-gray-800 lg:mt-[100px] md:mt-[100px] sm:mt-[85px]">
            <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                <div className="flex flex-col justify-center p-6 text-center rounded-sm sm:w-full lg:max-w-md xl:max-w-lg lg:text-left">
                    ...
                    <div className="flex lg:flex-row md:flex-row space-y-4 sm:items-center sm:justify-center sm:flex-col sm:space-y-0 sm:space-x-4 lg:justify-start">
                        <button className="px-8 py-3 text-lg font-semibold rounded-full my-4 bg-primary text-gray-50">Get Started</button>
                        <button  className="px-8 py-3 text-lg font-semibold border rounded-full border-gray-800">watch the  video</button>
                    </div>
                </div>
