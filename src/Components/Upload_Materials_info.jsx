    ...
    return (
        <div>
            <div className="relative w-full lg:h-36 md:h-36 sm:h-36 bg-primary  flex items-center justify-center">
                <h1 className="text-white text-3xl font-bold">Upload Materials info</h1>
            </div>
                    ...
                    <div className="p-6 space-y-6">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="p-6  border-gray-200 rounded-b">
                                <button className="text-white bg-primary   focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="submit">Upload Materials</button>
                            </div>
                        </form>
                    </div>
                </div>
